...
impl Workspace {
    ...
    pub(super) fn build_open_in_warp_button(
        ...
        ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(t!("terminal_context_menu.open_in_warp"), PrimaryTheme).on_click(move |ctx| {
    ...
    pub(super) fn build_view_cloud_runs_button(
        ...
        ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(t!("workspace.view_all_cloud_runs"), SecondaryTheme).on_click(move |ctx| {
