...
impl UserOwnedBlock {
    ...
    fn copy_link_button(&self, appearance: &Appearance, block_url: String) -> Box<dyn Element> {
        let button = appearance
            ...
            .with_text_label(t!("shared_blocks.copy_link").into());
...
impl ShowBlocksView {
    pub fn new(block_client: Arc<dyn BlockClient>, ctx: &mut ViewContext<Self>) -> Self {
        let menu = ctx.add_typed_action_view(|ctx| {
            ...
            menu.set_items(
                vec![MenuItem::Item(
                    MenuItemFields::new(t!("shared_blocks.unshare")).with_on_select_action(ShowBlocksAction::Unshare),
                )],
                ctx,
            );
                                ...
                                Flex::row()
                                    .with_child(
                                        ui_builder
                                            ...
                                            .with_text_label(t!("common.cancel").into())
                                            .build()
                                            .on_click(|ctx, _, _| {
                                    ...
                                    .with_child(
                                        Container::new(
                                            ui_builder
                                                ...
                                                .with_text_label(t!("shared_blocks.unshare").into())
                                                .build()
                                                .on_click(|ctx, _, _| {
                                                    ctx.dispatch_typed_action(
